# Common Platform Archiecture

This repository describes the archiecture of the Crime Common Platform. It uses the [LikeC4](https://likec4.dev/) tools and DSL to describe the model, and the principles of the [C4 modelling approach](https://c4model.com/).
